...
**Production Data** has been meticulously crafted with a focus on simplicity, ensuring that users can effortlessly execute tasks and operations with minimal interaction. A central objective in the development of this application has been the reduction of clicks required for seamless user experience.
...
![Production Data's DMG](/assets/md-install.png)

1. Download the DMG to your system.
2. Mount the DMG by double-clicking it.
3. Move **Production Data** to your Applications folder.
4. Launch **Production Data**.
...
![Production Data's Onboarding Screen](/assets/md-onboarding.gif)
